...
public class DList {
  ...
  public void insertFront(Object item) {
    DListNode oldFirst = head.next;
    DListNode newFirst = newNode(item, head, oldFirst);
  ...
  public void insertBack(Object item) {
    ...
    DListNode newBack = newNode(item, oldBack, head);
  ...
  public void remove(DListNode node) {
    if (node == null) return;
    DListNode left = node.prev;
    DListNode right = node.next;
    left.next = right;
    right.prev = left;
    node.prev = null;
    node.next = null;
