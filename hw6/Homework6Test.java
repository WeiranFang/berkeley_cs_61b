...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // from here.
    System.out.println(table.colDistribution());
    System.out.printf("Expected num of collisions is %.2f\n", table.expectedNumCollisions());
    System.out.println("Actual num of collisions is:" + table.numCollisions());
  }
