  ...
  public void insert(int key) {
    if (root == null) {
      ...
      if (root.keys == 3) {
        ...
        if (root.child1 != null) { root.child1.parent = newRoot.child1; }
        newRoot.child1.child2 = root.child2;
        if (root.child2 != null) { root.child2.parent = newRoot.child1; }
        newRoot.child2.child1 = root.child3;
        if (root.child3 != null) { root.child3.parent = newRoot.child2; }
        newRoot.child2.child2 = root.child4;
        if (root.child4 != null) { root.child4.parent = newRoot.child2; }
        ...
        if (key < node.key1) {
          ...
          if (node.child2 == null) {
            ...
            if (node.keys == 3) {
              ...
              if (key < node.parent.key2) {
                node = node.parent.child2;
              } else if (key > node.parent.key2) {
          ...
          if (node.child3 == null) {
            ...
            if (node.keys == 3) {
              ...
              if (key < node.parent.key3) {
                node = node.parent.child3;
              } else if (key > node.parent.key3) {
